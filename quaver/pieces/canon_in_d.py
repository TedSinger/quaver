...
BASE = tuple(map(Decrescendo(2), (D3, A2, B2, +F2, G2, D2, G2, A2)))

_PIZZ = (D3.maj, A2.maj, B2.min, (+F2).min, G2.maj, D2.maj, G2.maj, A2.maj)
PIZZ = T(12) ** Staccato ** SIXTEENTH ** \
    tuple((Z,) + (Decrescendo(2) ** tuple(sorted(c))) for c in _PIZZ)
...
BARS_22_25 = Staccato ** (D5, +C5, B4, D5, D4, D4, D4, E4) + (Z._8,) + \
    (Staccato ** (A4, A4, +F4, A4, G4, +F4, G4) + (E5._8,))
...
BARS_46_51 = (
    D5._8, D5, +C5, B4, A4, G4, +F4._5_16, E4._16, E4,
    +F4._8, +F5, E5._8, D5._8, D6, C6._8, B5, D6._8, A5._8, B5, A5,
    A5, A4._3_16, G4._16, +F4, +F5._3_16, E5._16, D5._3_8, D5._8, D5, +C4
)  # SIX measures
...
COMMON_VOICES = BARS_2_5 + BARS_6_9 + BARS_10_13 + BARS_14_17 + \
    BARS_18_21 + BARS_22_25 + BARS_26_29 + BARS_30_33 + BARS_34_37 + \
    BARS_38_41 + BARS_42_45 + BARS_46_51

PASSACAGLIA = {
    (BASE * 28, D2._3_8),
    PIZZ * 28,
    flatten(Louder(2) ** ((Z * 8,) + COMMON_VOICES + BARS_52_53 + BARS_54_55 + (A4._3_8,))),
    flatten((Z * 16,) + COMMON_VOICES + BARS_52_53 + (+F5._3_8,)),
    flatten((Z * 24,) + COMMON_VOICES + (D5._3_8,))}
