...
VOICE_2 = Stanza(D4, +F4, A4, G4, +F4, D4, +F4, E4,
                 D4, B3, D4, A4, G4, B4, A4, G4,
                 +F4, D4, E4, +C5, D5, +F5, A5, A4,
                 B4, G4, A4, +F4, D4, D5, (D5 * 3 / 2).trill(2), +C5 / 2) / 2

VOICE_3 = Stanza(D5, +C5, D5, D4, +C4, A4, E4, +F4,
...
VOICE_6 = ((D5 | +C5 | B4 | D5 | D4 | D4 | D4 | E4).staccato |
...
VOICE_9 = (D4 | D3 / 2 | E3 / 2 | +F3 | D3 | +C3 | +C4 / 2 | D4 / 2 | E4 | +C4 |
...
VOICE_12 = (D5 / 2 | D5 | +C5 | B4 | A4 | G4 | +F4 * 5 / 4 | E4 / 4 | E4 |
